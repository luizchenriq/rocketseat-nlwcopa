...
CREATE TABLE "Game" (
    ...
    "secodTeamCountryCode" TEXT NOT NULL
);
...
CREATE TABLE "Guess" (
    ...
    "participantd" TEXT NOT NULL,
    CONSTRAINT "Guess_participantd_fkey" FOREIGN KEY ("participantd") REFERENCES "Participant" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
